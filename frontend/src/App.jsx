...
// Backend responde com matching por palavra-chave sobre docs fake em
// backend/fake_data/. Não há LLM nem chamada externa.
    ...
    <header className="border-b border-slate-200/70 bg-white/70 backdrop-blur">
      <div className="mx-auto flex w-full max-w-3xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        <div className="flex items-center gap-2">
          <span className="hidden items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-2.5 py-1 text-[11px] font-medium text-emerald-700 sm:inline-flex">
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-center text-[11px] text-slate-400">
        Demonstração offline · respostas vêm de documentos simulados em{' '}
        <code className="font-mono">backend/fake_data/</code>
      </p>
    </form>
  )
}
